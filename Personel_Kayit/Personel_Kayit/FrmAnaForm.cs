...
namespace Personel_Kayit
{
    public partial class FrmAnaForm : Form
    {
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmdsehir.Text = dataGridView1.Rows[secilen].Cells[3].Value.ToString();
        ...
        {
            baglanti.Open();
            SqlCommand komutguncelle = new SqlCommand("Update Tbl_Personel Set PerAd=@a1,PerSoyad=@a2,PerSehir=@a3,PerMaas=@a4,PerDurum=@a5,PerMeslek=@a6 where Persid=@a7",baglanti);
            komutguncelle.Parameters.AddWithValue("@a1",txtisim.Text);
            komutguncelle.Parameters.AddWithValue("@a2",txtsoyad.Text);
            komutguncelle.Parameters.AddWithValue("@a3",cmdsehir.Text);
            ...
            baglanti.Close();
            MessageBox.Show("Mersonel Bilgi Güncellendi");
        }
